...
/***/ function(module, exports, __webpack_require__) {
	...
	var PromiseObservable_1 = __webpack_require__(182);
	var shared_1 = __webpack_require__(64);
	var async_1 = __webpack_require__(94);
	var collection_1 = __webpack_require__(39);
	var exceptions_1 = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginService = (function () {
	    ...
	    LoginService.prototype.login = function (username, password) {
	        var _this = this;
	        var credentials = { username: username, password: password }, headers = new http_1.Headers();
	        headers.append('Content-Type', 'application/json');
	        this.http
	            .post('http://localhost:3000/api/login', JSON.stringify(credentials), headers)
	    ...
	    LoginService.prototype.checkToken = function () {
	        var _this = this;
	        return this.http
	            .get('http://localhost:3000/api/checkToken')
	            .map(function (res) { return res.json(); })
	            .subscribe(function (data) { return alert('success'); }, function (err) { return _this.router.navigate(['/login']); });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var login_service_1 = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginComponent = (function () {
	    ...
	    LoginComponent.prototype.onSubmit = function (form) {
	        var username = form.value.username, password = form.value.password;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var http_1 = __webpack_require__(107);
	var testing_1 = __webpack_require__(370);
	var config_1 = __webpack_require__(552);
	var FakeBackendService = (function () {
	    function FakeBackendService(backend) {
	        var _this = this;
	        this.backend = backend;
	        this.isLoggedIn = false;
	        this.backend.connections.subscribe(function (connection) {
	            _this.handleRequests(connection);
	        });
	    }
	    FakeBackendService.prototype.handleRequests = function (connection) {
	        // POST login
	        if (connection.request.url === 'http://localhost:3000/api/login' && connection.request.method === 1) {
	            this.handleLogin(connection);
	        }
	        // GET checkToken
	        if (connection.request.url === 'http://localhost:3000/api/checkToken' && connection.request.method === 0) {
	            this.handleCheckToken(connection);
	        }
	    };
	    FakeBackendService.prototype.handleLogin = function (connection) {
	        var credentials = JSON.parse(connection.request.getBody()), isCredentialsValid = this.isCredentialsValid(credentials);
	        ...
	        // angular cant mock 401 response in normal way. Opened github issue: https://github.com/angular/angular/issues/7471
	    ...
	    FakeBackendService.prototype.handleCheckToken = function (connection) {
	        if (this.isLoggedIn) {
	            var options = new http_1.BaseResponseOptions();
	            options.body = { success: true };
	            connection.mockRespond(new http_1.Response(options));
	    ...
	    FakeBackendService.prototype.startSession = function () {
	        var _this = this;
	        clearTimeout(this.currentSession);
	        this.currentSession = setTimeout(function () { return _this.isLoggedIn = false; }, config_1.CONFIG.sessionExpireTime);
	    };
	    FakeBackendService.prototype.isCredentialsValid = function (credentials) {
	        return credentials.username == config_1.CONFIG.username && credentials.password == config_1.CONFIG.password;
	    };
	    FakeBackendService = __decorate([
	        core_1.Injectable(), 
	...
	exports.FakeBackendService = FakeBackendService;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Subscription_1 = __webpack_require__(180);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var core_1 = __webpack_require__(1);
	var ReplaySubject_1 = __webpack_require__(721);
	var Subject_1 = __webpack_require__(36);
	var take_1 = __webpack_require__(744);
	var enums_1 = __webpack_require__(54);
	var exceptions_1 = __webpack_require__(108);
	var lang_1 = __webpack_require__(28);
	var static_request_1 = __webpack_require__(242);
	/**
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http_1 = __webpack_require__(107);
	var testing_1 = __webpack_require__(370);
	var http_2 = __webpack_require__(107);
	var app_routes_1 = __webpack_require__(550);
	var app_1 = __webpack_require__(551);
	var dashboard_component_1 = __webpack_require__(388);
	var login_component_1 = __webpack_require__(389);
	var login_service_1 = __webpack_require__(169);
	var auth_guard_service_1 = __webpack_require__(390);
	var fake_backend_service_1 = __webpack_require__(391);
	var AppModule = (function () {
	    function AppModule() {
	    }
	    AppModule = __decorate([
	        core_1.NgModule({
	            declarations: [app_1.AppComponent, dashboard_component_1.DashboardComponent, login_component_1.LoginComponent],
	            ...
	            providers: [
	                ...
	                fake_backend_service_1.FakeBackendService,
	                {
	                    provide: http_2.Http,
	                    deps: [testing_1.MockBackend, http_2.BaseRequestOptions],
	                    useFactory: function (backend, options) {
	                        return new http_2.Http(backend, options);
	                    }
	                }
	            ],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = (function () {
	    function AppComponent(fakeBackendService) {
	        this.fakeBackendService = fakeBackendService;
	    }
	    AppComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_a = typeof fake_backend_service_1.FakeBackendService !== 'undefined' && fake_backend_service_1.FakeBackendService) === 'function' && _a) || Object])
	    ], AppComponent);
	    return AppComponent;
	    var _a;
	}());
...
/***/ function(module, exports) {
	...
	module.exports = "<h3>Dashboard</h3>\n\n<button (click)=\"onClick()\" class=\"btn btn-default\">Check token</button>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Subject_1 = __webpack_require__(36);
	var queue_1 = __webpack_require__(747);
	var observeOn_1 = __webpack_require__(433);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArgumentOutOfRangeError_1 = __webpack_require__(748);
	var EmptyObservable_1 = __webpack_require__(181);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FutureAction_1 = __webpack_require__(434);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @ignore
	 * @extends {Ignored}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var QueueAction_1 = __webpack_require__(745);
	var FutureAction_1 = __webpack_require__(434);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var QueueScheduler_1 = __webpack_require__(746);
